...
//↓ Inicio del Agregado ============================================================================
        //MOUSEDRAG: //Agregada para darle funcionalidad a arrastrar con el mouse
        if (slider.vars.mousedrag){
          let i, f; //Inicio - Fin
          /* Disparado cuando se presiona el botón del mouse */
          slider.bind('mousedown', function(event) {
            event.preventDefault();
            i = event.clientX;
          });
          /*Disparado cuando se suelta el botón del mouse*/
          ...
          // function estado(texto){ //Función para ver el estado de las variables
          //   console.log(texto+" \ni = "+i+"\nf = "+f);
          // }
        }
// ↑ Fin del agragado =============================================================================
